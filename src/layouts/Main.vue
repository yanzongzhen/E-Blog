      ...
      <Content :style="{padding: '20px 20px', height: '100%'}">
        <Row>
          <Col :xs="24" :sm="24" :md="18" :lg="18" style="height:auto;border-radius:10px">
            <lun-bo class="side-content-bottom" style="display: none; margin-bottom: 10px"></lun-bo>
          ...
          <Col :md="{span:6}" :lg="{span:6}" class="side-content">
            <div style="height: 100%;">
              ...
              <div class="tools">
                <search-bar @search-data="getSearchData"></search-bar>
              </div>
              <div class="tools">
                <e-tag :data="TagData" @clickTag="clickTagItem"></e-tag>
              </div>
              <div class="tools">
                <friend-link :friendLinks="friendlinks"></friend-link>
              </div>
            </div>
          </Col>
        </Row>
...
<script>
import eTag from '@/components/CloudTag'
